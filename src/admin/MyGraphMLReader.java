 ...
 */
public class MyGraphMLReader extends AbstractGraphReader implements GraphReader {
    ...
    public Graph readGraph(InputStream is) throws DataIOException {
        try {
            ...
            nodeMap = handler.m_nodeMap;

            return handler.getGraph();
        } catch ( Exception e ) {
            System.out.println("Exception when read graph ML file: " + e);
  ...
  public  HashMap getNodeMap(){
    ...
    public static class GraphMLHandler extends DefaultHandler implements Tokens
    {
        ...
        public void endDocument() throws SAXException {
            ...
            System.out.println("Exception at end doc when read graphML file: " + e);
            }
        }
...
//                m_edges.setBoolean(m_row, DIRECTED, d);
                ...
                String localName, String qName)
        {
            ...
            System.out.println("Exception at endElement when reading graphML: " + dpe);
        ...
        protected void addToSchema() {
            ...
            try {
                ...
                System.out.println("DataParseException: " + dpe);
                error(dpe);
            }
        }
