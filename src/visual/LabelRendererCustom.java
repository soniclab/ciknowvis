 ...
 * {@link #getText(prefuse.visual.VisualItem)} method. When the text field is
 ...
 * internally by an {@link prefuse.render.ImageFactory} instance, which maintains a
 ...
 */
public class LabelRendererCustom extends AbstractShapeRenderer {
     ...
     */
    public LabelRendererCustom(String textField) {
     ...
     * drawn.
     */
    public LabelRendererCustom(String textField, String imageField) {
    ...
    public void render(Graphics2D g, VisualItem item) {
        ...
        if ( text == null && img == null )
          ...
          double size = item.getSize();
      //  int nodesize = (int)item.getDouble("recId");
          double nodeHeight =  item.getBounds().getHeight();
      ...
      // double y = shape.getMinY() + size*m_vertBorder;
        ...
        // double y = shape.getMinY() + size*m_vertBorder-nodeHeight;
        double  y = shape.getMinY() -nodeHeight*0.45;
