...
public class FocusNodeReminderDialog extends JDialog implements ActionListener {
    ...
    private String copyright1 = "Please select only one node";
    private String copyright2 = "as the root node !";



    public FocusNodeReminderDialog(MainFrame frame) {
